...
| `INCOMING.navCoin.walletPassphrase`       | `string`      | true    | '44444' | walletpassphrase to use to unlock the wallet for transactions. If the wallet is unencrypted, this will be used to encrypt it during setup |
...
| `INCOMING.subChain.walletPassphrase`       | `string`      | true    | '44444' | walletpassphrase to use to unlock the wallet for transactions. If the wallet is unencrypted, this will be used to encrypt it during setup |
...
| `OUTGOING.navCoin.walletPassphrase`       | `string`      | true    | '44444' | walletpassphrase to use to unlock the wallet for transactions. If the wallet is unencrypted, this will be used to encrypt it during setup |
...
| `OUTGOING.subChain.walletPassphrase`       | `string`      | true    | '44444' | walletpassphrase to use to unlock the wallet for transactions. If the wallet is unencrypted, this will be used to encrypt it during setup |
